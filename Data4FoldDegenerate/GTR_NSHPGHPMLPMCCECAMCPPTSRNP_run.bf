...
*/
global mu=1; global pnG=0.25; global pnC=0.25; global pnA=0.25; global exchAG=1.0; global exchCG=1.0; global exchGT=1.0; global exchCT=1.0; global exchAT=1.0; 
global pnT:=1.0-(pnG+pnC+pnA); 
...
/* Read in the data */
DataSet	raw_data = ReadDataFile("/home/thibault/NucleotideBias/Data4FoldDegenerate/CDS.NSHPGHPMLPMCCECAMCPPTSRNP.fasta");
...
fprintf ("GTR_NSHPGHPMLPMCCECAMCPPTSRNP_run.bf_hyout.txt", LikStateModel);